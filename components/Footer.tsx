        ...
        <div className="py-12 lg:py-16 grid gap-10 md:gap-12 md:grid-cols-12">
          ...
          <div className="md:col-span-4 grid grid-cols-2 gap-8">
            <div>
              ...
              <div className="grid gap-3 text-sm">
                ...
                <Link href="/roi-calculator" className="text-[rgba(254,255,255,0.72)] hover:text-polus-gold transition">ROI Calculator</Link>
          ...
          <div className="md:col-span-3">
            ...
            <div className="grid gap-3 text-sm">
              ...
              <Link href="/disclaimer" className="text-[rgba(254,255,255,0.72)] hover:text-polus-gold transition">Disclaimer</Link>
